...
#parser.add_argument("--cadence",help="Cadence for multiple batches generation and fiber assignment",type=int, default=28)
...
n = mb.prepare_tile_batches(surveysim_file=args.expfile, output_path=exp_outdir, start_day=args.first_day, end_day=args.last_day)
